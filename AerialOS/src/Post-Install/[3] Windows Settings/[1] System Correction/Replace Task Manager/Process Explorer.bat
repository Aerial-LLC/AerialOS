...
powershell -command "(New-Object System.Net.WebClient).DownloadFile('https://download.sysinternals.com/files/ProcessExplorer.zip', '%temp%\ProcessExplorer.zip')" >nul 2>&1
powershell Expand-Archive -Path "%temp%\ProcessExplorer.zip" -DestinationPath "%temp%" >nul 2>&1

move /y "%temp%\procexp64.exe" "%windir%" >nul 2>&1
del /s /q "%Temp%\ProcessExplorer.zip" >nul 2>&1 & del /s /q "%Temp%\procexp.exe" >nul 2>&1 & del /s /q "%Temp%\procexp64a.exe" >nul 2>&1
...
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "SysinfoWindowplacement" /t REG_BINARY /d "2c00000000000000010000000000000000000000ffffffffffffffff28000000280000002c03000042020000" /f >nul 2>&1
...
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "Divider" /t REG_BINARY /d "3d0ad7a3703dea3f" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "SavedDivider" /t REG_BINARY /d "3d0ad7a3703dea3f" /f >nul 2>&1
...
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "AlwaysOntop" /t REG_DWORD /d "1" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "OneInstance" /t REG_DWORD /d "1" /f >nul 2>&1
...
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "DefaultSysInfoPage" /t REG_DWORD /d "1" /f >nul 2>&1
...
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorPackedDark" /t REG_DWORD /d "3604508" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorImmersive" /t REG_DWORD /d "15395328" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorImmersiveDark" /t REG_DWORD /d "3355392" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorOwn" /t REG_DWORD /d "16765136" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorOwnDark" /t REG_DWORD /d "6553600" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorServices" /t REG_DWORD /d "13684991" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorServicesDark" /t REG_DWORD /d "100" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorRelocatedDlls" /t REG_DWORD /d "10551295" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorRelocatedDllsDark" /t REG_DWORD /d "22873" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorGraphBk" /t REG_DWORD /d "15790320" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorGraphBkDark" /t REG_DWORD /d "3421236" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorJobs" /t REG_DWORD /d "27856" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorJobsDark" /t REG_DWORD /d "5933" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorDelProc" /t REG_DWORD /d "4605695" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorDelProcDark" /t REG_DWORD /d "70" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorNewProc" /t REG_DWORD /d "4652870" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorNewProcDark" /t REG_DWORD /d "17920" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorNet" /t REG_DWORD /d "10551295" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorNetDark" /t REG_DWORD /d "22873" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorProtected" /t REG_DWORD /d "8388863" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorProtectedDark" /t REG_DWORD /d "1835063" /f >nul 2>&1
...
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ColorSuspendDark" /t REG_DWORD /d "1776411" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "StatusBarColumns" /t REG_DWORD /d "13589" /f >nul 2>&1
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "ShowAllCpus" /t REG_DWORD /d "1" /f >nul 2>&1
...
Reg.exe add "HKCU\SOFTWARE\Sysinternals\Process Explorer" /v "Theme" /t REG_SZ /d "" /f >nul 2>&1
